...
const portugueseMessages: TranslationMessages = {
  ra: {
    ...
    message: {
      ...
      auth_error: 'Um erro ocorreu durante a validação do token de autenticação.',
      bulk_delete_content:
      ...
      clear_array_input: 'Você tem certeza de que deseja limpar toda a lista?',
    ...
    saved_queries: {
      ...
      remove_message: 'Tem certeza de que deseja remover este item da sua lista de consultas salvas?',
